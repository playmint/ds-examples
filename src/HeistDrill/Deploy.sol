...
contract Deployer is Script {
    ...
    function deploy() private {
        ...
        BuildingUtils.register(
            ds,
            BuildingConfig({
                id: nameToId("heist-drill"),
                name: "Shop Heist Drill",
                materials: [
                    Material({quantity: 25, item: glassGreenGoo}),
                    Material({quantity: 25, item: beakerBlueGoo}),
                    Material({quantity: 25, item: flaskRedGoo}),
                ...
                plugin: vm.readFile("src/HeistDrill/BuildingKind.js")
            })
        );
    }
